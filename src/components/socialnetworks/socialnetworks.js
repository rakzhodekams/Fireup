const social = {
  ...
  github: '<a target="_blank" href="https://github.com/rakzhodekams"><img width="24px" src="./img/icons8-octocat-48.png"></a>',
  gitlab: '<a target="_blank" href="https://gitlab.com/OdicforceSounds"><img width="24px" src="./img/icons8-gitlab-48.png"></a>',
  instagram: '<a target="_blank" href="https://www.instagram.com/odicforcesounds/"><img width="24px" src="./img/icons8-instagram-48.png"></a>',
  keybase: '<a target="_blank" href="https://keybase.io/path_of_shields"><img width="24px" src="./img/icons8-keybase-48.png"></a>',
  reddit: '<a target="_blank" href="https://www.reddit.com/user/odicforcesounds/"><img width="24px" src="./img/icons8-reddit-48.png"></a>',
  stackoverflow: '<a target="_blank" href="https://stackoverflow.com/users/6806076/odicforcesounds"><img width="24px" src="./img/icons8-stack-overflow-48.png"></a>',
  ...
  for (var property in social) {
    if (social.hasOwnProperty(property)) {
      ...
      if ( target !== null ) {
        ...
        target[property] = target.body.rotation(100);
      }
    }
  }
}populate();
